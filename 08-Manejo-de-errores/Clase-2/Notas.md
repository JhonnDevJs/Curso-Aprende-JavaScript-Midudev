...
En la lección anterior aprendimos sobre try/catch. Ahora vamos a conocer finally, un bloque adicional que siempre se ejecuta, sin importar si ocurrió un error o no. Es perfecto para código de limpieza o tareas que deben completarse sin importar si hay errores o no.

¿Cómo funciona y para qué sirve?
Finally es un bloque opcional que se puede añadir después de try/catch. Su código siempre se ejecuta, independientemente de si:
