...
Examen interactivo
¿Qué valor devuelve Symbol('test') === Symbol('test')?
...
undefined
¿Cuál es la diferencia entre Symbol('key') y Symbol.for('key')?

No hay diferencia

Symbol() crea único, Symbol.for() reutiliza del registro global

Symbol.for() es más rápido
¿Los símbolos aparecen en for...in loops?

Sí, siempre

No, nunca

Solo si se crean con Symbol.for()
¿Cómo se puede convertir un símbolo a string de forma segura?

symbol + ""

symbol.toString() o String(symbol)

JSON.stringify(symbol)
¿Qué método usarías para obtener todos los símbolos de un objeto?
